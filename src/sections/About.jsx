...
const About = () => {
  const skills = [
    'Java', 'JavaScript', 'React js', 'Spring Boot',
...
I enjoy learning new skills, solving problems, and continuously improving as a developer.
              ...
              <p className="text-gray-300 leading-relaxed">
                I focus on writing clean and simple code while continuously learning new technologies. When I’m not coding, I like exploring new ideas, improving my skills, and working on personal projects to grow as a developer.

              </p>
            </div>

            <div className="glass p-6 rounded-xl">
              <h3 className="text-2xl font-bold text-white mb-4">Technologies I Love</h3>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300"
              >
                Let's Connect
              </motion.button>
